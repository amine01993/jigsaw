...
const Header = () => {
    return (
        <>
            <header className="fixed top-4 left-1/2 -translate-x-1/2 flex justify-between items-center p-4 h-12 rounded-lg bg-black/10 dark:bg-white/10 backdrop-blur-sm transition-colors duration-300 z-1">
                <MotionLink to="/">
                    <img
                        src="/logo.svg"
